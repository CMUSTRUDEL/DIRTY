...
from utils.vocab import Vocab, VocabEntry, SAME_VARIABLE_TOKEN
...
class RecurrentDecoder(Decoder):
    ...
    def forward(self, src_ast_encoding, prediction_target):
        ...
        variable_master_node_restoration_indices = src_ast_encoding['variable_master_node_restoration_indices']
        variable_master_node_restoration_indices_mask = src_ast_encoding['variable_master_node_restoration_indices_mask']
    ...
    def get_target_log_prob(self, var_name_log_probs, prediction_target, src_ast_encoding):
        # (batch_size, max_prediction_node_num)
        variable_tgt_name_id = prediction_target['variable_tgt_name_id'][src_ast_encoding['variable_master_node_restoration_indices']]
        tgt_var_name_log_prob = torch.gather(var_name_log_probs,
                                             dim=-1, index=variable_tgt_name_id.unsqueeze(-1)).squeeze(-1)

        tgt_var_name_log_prob = tgt_var_name_log_prob * src_ast_encoding['variable_master_node_restoration_indices_mask']
